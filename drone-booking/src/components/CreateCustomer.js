    ...
    <>
      ...
      >
        ...
        <TextField
          ...
          sx={{ width: "100%", mb: 2 }}
          error={!validator.isEmail(state.email)}
          value={state.email}
          onChange={(e) =>
          ...
          >
            ...
            <Box>  
              ...
              />
                ...
                <Box sx={{ display: "flex" }}>
                  <Button variant="contained" color="info" onClick={handleCreate} disabled = {!validator.isEmail(state.email) || state.phone.length !== 10 || state.name===""}>
                    Create
                  </Button>
                </Box>
